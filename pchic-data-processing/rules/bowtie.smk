...
rule bowtie_build:
    input:
        ...
        reference = '/data/project/dohoon/reference/mm10/mm10.fa',
    output:
        # e.g.
        # reference_indices = config['reference']['genome']['bowtie_index_dir']
        index_dir = '/data/project/dohoon/reference/mm10/bowtie2_index',
    params:
    ...
    threads: 8
    benchmark:
        repeat('benchmarks/bowtie_build/bowtie2.tsv', 1)
    log: 'logs/bowtie_build/bowtie2.log'
    wrapper:
